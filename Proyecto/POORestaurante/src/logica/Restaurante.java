...
public class Restaurante {
	...
	public void imprimirFacturas() {
		for(Factura factura : this.facturas) {
			System.out.println("-------");
			System.out.println(factura.getNumero() + " FECHA: " + factura.getFecha() + " VALOR TOTAL: "+ factura.getValorTotal()+ " VALOR TOTAL CON DESCUENTO: "+ factura.getValorTotal()+" NOMBRE CAJERO "+ factura.getCajero().getNombre());
			for(FacturaPedido facturaPedido : factura.getFacturaPedidos()) {
				System.out.println(" PEDIDO: " +facturaPedido.getPedido().getNombrep() + " CANTIDAD: " + facturaPedido.getCantidad() + " PRECIO UND: " + facturaPedido.getPrecio());
			}
		}
