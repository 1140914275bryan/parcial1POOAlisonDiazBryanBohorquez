...
public class TipoPedido {
	...
	public void ingresarPedido(int numerodeeleccion, String nombre2, int precioVenta, int cantidad) {
		Pedido pedido = new Pedido(numerodeeleccion, nombre,precioVenta, cantidad);
